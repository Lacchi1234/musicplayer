...
# used to provides classes and factory functions for creating file/dir slection windows
from tkinter import *
import pygame 
import os 
...
menubar = Menu(root)#adding the menu bar
...
def load_music():#to make an action on buttons ,select folder
    global current_song
...
def next_music(): 
    ...
    try:
        ...
        pass
#use try except to prevent the error if the songs are no more in list        
